<html>
    ...
    <body>
        <div class="pbr"><img src="images/cover_pages/<?php echo $coverpage->rename_image;?>"></div>
        <div class="pbr"></div>
        <div class="pbr">
            <h2>Table of Contents</h2>
        </div>
        <div class="pbr"><img src="images/parts/<?php echo $partimage->rename_image;?>"></div>
        <div>
            <table class="list" style="width: 99%; margin-top: 1em;">
                <tr class="head">
                    <td class="center" style="width: 15%">BOM Part#</td>
                    <td style="width: 30%">WAI Part#</td>
                    <td class="center" style="width: 10%">WAI Line Description</td>
                    <td class="center" style="width: 10%">Manufacturer</td>
                    <td class="center" colspan="2" style="width: 15%">Image</td>
                </tr>

                <?php
                foreach($bom_details as $bompart)
                {
                ?>
                <tr class="list_row">
